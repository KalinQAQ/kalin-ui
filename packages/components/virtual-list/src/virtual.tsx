...
export default defineComponent({
  ...
  setup(props, { slots }) {
    ...
    const warpperRef = ref<HTMLElement>()
    ...
    const handleScroll = () => {
      // 根据当前滚动的距离，计算过去了几个数据
      const scrollTop = warpperRef.value!.scrollTop
    ...
    function initWrapper() {
      warpperRef.value!.style.height = props.remain * props.size + 'px'
    ...
    return () => {
      return (
        <div class={bem.b()} ref={warpperRef} onScroll={handleScroll}>
          {/* 就是模拟总长度，感觉好像很多数据 */}
